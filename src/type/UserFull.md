...
section: ref
kind: type
description: "Объект содержит расширенную информацию о пользователе."
layout: layout.njk
---

# UserFull

Объект содержит расширенную информацию о пользователе.
...
<table class="table"><thead><tr><th scope="col">Конструктор</th><th scope="col">Описание</th></tr></thead><tbody><tr><td><a href="/constructor/userFull">userFull</a></td><td>Расширенные сведения о пользователе<br><br>При обновлении <a href="/api/peers">локальной базы пиров »</a> все поля вновь полученного конструктора имеют приоритет над старым конструктором, сохранённым локально (в том числе путём удаления полей, не заданных в новом конструкторе).</td></tr></tbody></table>
