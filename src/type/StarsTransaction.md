...
section: ref
kind: type
description: "Представляет транзакцию Telegram Stars »."
layout: layout.njk
---

# StarsTransaction

Представляет [транзакцию Telegram Stars »](/api/stars/).
...
<table class="table"><thead><tr><th scope="col">Конструктор</th><th scope="col">Описание</th></tr></thead><tbody><tr><td><a href="/constructor/starsTransaction">starsTransaction</a></td><td>Представляет <a href="/api/stars">транзакцию в Telegram Stars или TON »</a>.</td></tr></tbody></table>
