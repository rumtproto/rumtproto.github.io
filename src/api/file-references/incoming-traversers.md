---
title: "Входящие обходчики ссылок на файлы"
original: "https://core.telegram.org/api/file-references/incoming-traversers"
section: api
description: "Полный список входящих обходчиков, содержащихся в текущем файле карты ссылок на файлы » (file_reference — ссылка на файл, короткий бинарный маркер, который сервер выдаёт вместе с…"
layout: layout.njk
---

# Входящие обходчики ссылок на файлы

[@term:file_reference] Полный список входящих обходчиков, содержащихся в текущем [файле карты ссылок на файлы »](/api/file-references/#map-file) (`file_reference` — ссылка на файл, короткий двоичный маркер: сервер выдаёт его вместе с файлом, и это значение нужно предъявить при скачивании).

О том, как работают входящие обходчики, подробнее рассказано [здесь »](/api/file-references/#incoming-traversers).
