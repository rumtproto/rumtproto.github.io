---
title: "businessRecipients (конструктор)"
...
| users | [flags](https://core.telegram.org/mtproto/TL-combinators#conditional-fields).4?[Vector](https://core.telegram.org/type/Vector%20t)<[long](/type/long/)> | Only private chats with the specified users. |
