...
section: ref
kind: constructor
description: "Представляет проблему с селфи с документом. Ошибка считается устранённой, когда файл с селфи меняется."
layout: layout.njk
---

# secureValueErrorSelfie

Представляет проблему с селфи с документом. Ошибка считается устранённой, когда файл с селфи меняется.
