...
section: ref
kind: constructor
description: "Представляет удаление в diff: отобразите его, просто подчеркнув указанный фрагмент и окрасив его в красный цвет; подробнее об отображении сущностей diff см. здесь »."
layout: layout.njk
---

# messageEntityDiffDelete

Представляет удаление в diff: отобразите его, просто подчеркнув указанный фрагмент и окрасив его в красный цвет; подробнее об отображении сущностей diff см. [здесь »](/api/entities/#diff-entities).
