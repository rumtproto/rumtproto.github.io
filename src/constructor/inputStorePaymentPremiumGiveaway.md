...
section: ref
kind: constructor
description: "Используется для оплаты розыгрыша; подробнее см. здесь »."
layout: layout.njk
---
