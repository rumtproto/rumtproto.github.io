...
original: "https://core.telegram.org/constructor/privacyValueAllowChatParticipants"
section: ref
kind: constructor
description: "Разрешить всем участникам определённых чатов"
layout: layout.njk
---

# privacyValueAllowChatParticipants

Разрешить всем участникам определённых чатов
...
<table class="table"><thead><tr><th scope="col">Имя</th><th scope="col" style="text-align: center;">Тип</th><th scope="col">Описание</th></tr></thead><tbody><tr><td><strong>chats</strong></td><td style="text-align: center;"><a href="/type/Vector%20t">Vector</a>&lt;<a href="/type/long">long</a>&gt;</td><td>Разрешённые идентификаторы чатов (идентификатор <a href="/constructor/chat">чата</a> или <a href="/constructor/channel">супергруппы</a>, в точности в том виде, в каком он получен в конструкторе (то есть, в отличие от идентификаторов Bot API, здесь идентификаторы групп и супергрупп следует обрабатывать одинаково)).</td></tr></tbody></table>
