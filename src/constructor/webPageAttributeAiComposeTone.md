...
section: ref
kind: constructor
description: "Атрибут веб-страницы, прикреплённый к webPage типа telegram_aicomposetone; создаётся при предпросмотре тона ИИ-редактора », которым поделились через ссылку на тон ИИ-редактора »."
layout: layout.njk
---
...
<table class="table"><thead><tr><th scope="col">Имя</th><th scope="col" style="text-align: center;">Тип</th><th scope="col">Описание</th></tr></thead><tbody><tr><td><strong>emoji_id</strong></td><td style="text-align: center;"><a href="/type/long">long</a></td><td><a href="/api/custom-emoji">Идентификатор пользовательского эмодзи</a> значка тона</td></tr></tbody></table>
