---
title: "inputPrivacyValueDisallowChatParticipants (конструктор)"
...
| Имя | Тип | Описание |
|---|---|---|
| chats | [Vector](https://core.telegram.org/type/Vector%20t)<[long](/type/long/)> | Disallowed chat IDs (either a [chat](/constructor/chat/) or a [supergroup](/constructor/channel/) ID, verbatim the way it is received in the constructor (i.e. unlike with bot API IDs, here group and supergroup IDs should be treated in the same way)). |
