...
original: "https://core.telegram.org/constructor/webPageAttributeStarGiftAuction"
section: ref
kind: constructor
description: "Содержит информацию об аукционе коллекционного подарка » для предпросмотра webPage аукциона » (у webPage поле type будет равно telegram_auction)."
layout: layout.njk
---
