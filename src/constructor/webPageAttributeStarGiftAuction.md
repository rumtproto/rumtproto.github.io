---
title: "webPageAttributeStarGiftAuction (конструктор)"
...
| Имя | Тип | Описание |
|---|---|---|
| gift | [StarGift](/type/StarGift/) | The gift linked to the auction |
| end_date | [int](/type/int/) | Date when the auction will end (UNIX timestamp) |
