...
section: ref
kind: constructor
description: "Кнопка для запроса геолокации пользователя"
layout: layout.njk
---

# keyboardButtonRequestGeoLocation

Кнопка для запроса геолокации пользователя

Доступно только в личных чатах, в [клавиатурах ответа](/constructor/replyKeyboardMarkup/).

При нажатии клиенты обязаны запросить у пользователя разрешение на отправку геолокации текущего пользователя в чат, отвечая на сообщение, к которому был приложен [replyKeyboardMarkup](/constructor/replyKeyboardMarkup/).
