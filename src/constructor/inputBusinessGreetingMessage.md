---
title: "inputBusinessGreetingMessage (конструктор)"
...
| recipients | [InputBusinessRecipients](/type/InputBusinessRecipients/) | Allowed recipients for the greeting messages. |
