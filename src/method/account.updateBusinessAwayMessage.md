---
title: "account.updateBusinessAwayMessage (метод)"
...
| message | [flags](https://core.telegram.org/mtproto/TL-combinators#conditional-fields).0?[InputBusinessAwayMessage](/type/InputBusinessAwayMessage/) | Away message configuration and contents. |
