...
section: ref
kind: method
description: "Задать рекомендуемые права администратора по умолчанию для ботов, добавляемых администраторами в каналы; подробнее о том, как их обрабатывать »."
layout: layout.njk
---

# bots.setBotBroadcastDefaultAdminRights

Задать [рекомендуемые права администратора](/api/rights/#suggested-bot-rights) по умолчанию для ботов, добавляемых администраторами в каналы; [подробнее о том, как их обрабатывать »](/api/rights/#suggested-bot-rights).
