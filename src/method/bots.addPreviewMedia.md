---
title: "bots.addPreviewMedia (метод)"
...
| lang_code | [string](/type/string/) | ISO 639-1 language code, indicating the localization of the preview to add. |
| media | [InputMedia](/type/InputMedia/) | The photo/video preview, uploaded using [messages.uploadMedia](/method/messages.uploadMedia/). |
