...
section: ref
kind: method
description: "Добавить превью Main Mini App, подробнее см. здесь »."
layout: layout.njk
---

# bots.addPreviewMedia

[@term:Mini App] Добавить [превью Main Mini App, подробнее см. здесь »](/api/bots/webapps/#main-mini-app-previews).
