---
title: "phone.toggleGroupCallStartSubscription (метод)"
...
| Имя | Тип | Описание |
|---|---|---|
| call | [InputGroupCall](/type/InputGroupCall/) | Scheduled video chat/livestream that has not started yet |
| subscribed | [Bool](/type/Bool/) | Whether to receive a service-notification message when the call starts |
