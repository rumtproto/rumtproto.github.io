...
section: ref
kind: method
description: "Получить строки пакета локализации"
layout: layout.njk
---

# langpack.getLangPack

Получить строки пакета локализации
...
<table class="table"><thead><tr><th scope="col">Код</th><th scope="col">Тип</th><th scope="col">Описание</th></tr></thead><tbody><tr><td>400</td><td>LANGUAGE_INVALID</td><td>Указанное значение lang_code недействительно.</td></tr><tr><td>400</td><td>LANG_CODE_NOT_SUPPORTED</td><td>Указанный код языка не поддерживается.</td></tr><tr><td>400</td><td>LANG_PACK_INVALID</td><td>Указанный языковой пакет недействителен.</td></tr></tbody></table>
