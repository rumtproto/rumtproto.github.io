---
title: "messages.getWebPage (метод)"
...
| Имя | Тип | Описание |
|---|---|---|
| url | [string](/type/string/) | URL of IV page to fetch |
| hash | [int](/type/int/) | [Hash used for caching, for more info click here](https://core.telegram.org/api/offsets#hash-generation). Note: the usual hash generation algorithm cannot be used in this case, please re-use the [webPage](/constructor/webPage/).hash field returned by a previous call to the method, or pass 0 if this is the first call or if the previous call did not return a [webPage](/constructor/webPage/). |
