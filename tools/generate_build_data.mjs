...
// Kept separate from apply_translations.mjs so the output is inspectable and
...
import { headingAliases, headingIds, headingTexts } from './lib/anchors.mjs';
...
const nav = JSON.parse(readFileSync('mirror/src/_data/nav.json', 'utf8'));
...
json('build/_data/site.json', {
  ...JSON.parse(readFileSync('mirror/src/_data/site.json', 'utf8')),
