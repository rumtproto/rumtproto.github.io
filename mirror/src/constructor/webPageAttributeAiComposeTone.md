...
original: "https://core.telegram.org/constructor/webPageAttributeAiComposeTone"
section: ref
description: "Webpage attribute attached to a webPage of type telegram_aicomposetone, generated when previewing a shared AI composer tone » via an AI compose tone link »."
crumbs: [{"title":"API","url":"/api/"},{"title":"TL-schema","url":"/schema/"},{"title":"webPageAttributeAiComposeTone","url":"/constructor/webPageAttributeAiComposeTone/"}]
layout: layout.njk
---
...
<table class="table"><thead><tr><th scope="col">Name</th><th scope="col" style="text-align: center;">Type</th><th scope="col">Description</th></tr></thead><tbody><tr><td><strong>emoji_id</strong></td><td style="text-align: center;"><a href="/type/long/">long</a></td><td><a href="/api/custom-emoji/">Custom emoji ID</a> of the tone's icon</td></tr></tbody></table>
