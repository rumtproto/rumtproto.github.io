---
title: "Telegram Gateway – Fast, Affordable, and Secure User Verification"
original: "https://core.telegram.org/gateway"
section: other
description: "Telegram Gateway is a cost-effective and privacy-focused solution for user authentication, allowing businesses to verify their customers’ phone numbers through Telegram at a…"
crumbs: []
layout: layout.njk
---
...
-   **Easy integration** with a [clear API](/gateway/api/).
...
<div class="blog_video_player_wrap" style="max-width: 600px; margin: 20px auto 20px;"><div><video class="blog_video_player tl_blog_vid_autoplay" onclick="videoTogglePlay(this)" autoplay="" loop="" controls="" muted="" poster="https://core.telegram.org/file/400780400519/2/lNZQaAkJ9QM.37203/8f106e392d786abf8d" style="max-width: 600px;" alt="Verification platform"><source src="https://core.telegram.org/file/400780400123/3/z0SrtopuptI.1065086.mp4/0afe2583ac58fd6a35" type="video/mp4"></video></div></div>

This page will walk you through the main benefits and features of the **Telegram Gateway**.  
For more information, see:

-   [FAQ](#faq)
-   [**Quick-Start Guide**](/gateway/verification-tutorial/)
-   [Full Gateway API Reference for Developers](/gateway/api/)
-   [Gateway API Terms of Service](/tos/gateway/)

### What can you do with Telegram Gateway?

-   [Authenticate Users Anywhere](#authenticate-users-anywhere)
-   [Reduce Acquisition Costs](#reduce-acquisition-costs)
-   [Access Detailed Statistics](#access-detailed-statistics)
-   [Deliver Messages Securely](#deliver-messages-securely)
-   [Build an Audience](#build-an-audience)

#### Authenticate Users Anywhere

To access Telegram, registered users only need an internet connection. Thanks to the **Telegram Verification Platform**, accessible by developers via the [Gateway API](/gateway/api/), users can conveniently receive your message on **mobile** or **desktop**, without needing an active SMS plan from their provider.

<div class="blog_image_wrap blog_wide_image_wrap"><a href="https://core.telegram.org/file/400780400656/3/9iBg_m8EjJs.349165/64ba1e8722d15e124d" target="_blank"><img src="https://core.telegram.org/file/400780400056/4/dJCmmM9Kytg.150900/c5553bdb185c273b8f" title="" alt="Costs Per Message" srcset="/file/400780400656/3/9iBg_m8EjJs.349165/64ba1e8722d15e124d , 2x"></a></div>
...
<div class="blog_image_wrap blog_wide_image_wrap"><a href="https://core.telegram.org/file/400780400658/1/KzqXYJ29JGs.45959/e1be634e32ae8b8f00" target="_blank"><img src="https://core.telegram.org/file/400780400658/1/KzqXYJ29JGs.45959/e1be634e32ae8b8f00" title="" alt="Costs Per Message" srcset="/file/400780400658/1/KzqXYJ29JGs.45959/e1be634e32ae8b8f00 , 2x"></a></div>
...
<div class="blog_image_wrap blog_wide_image_wrap"><a href="https://core.telegram.org/file/400780400146/1/3uChLsddQE4.79753/a4051359d04719de58" target="_blank"><img src="https://core.telegram.org/file/400780400146/1/3uChLsddQE4.79753/a4051359d04719de58" title="" alt="Detailed Statistics" srcset="/file/400780400146/1/3uChLsddQE4.79753/a4051359d04719de58 , 2x"></a></div>
...
<div class="blog_image_wrap blog_wide_image_wrap"><a href="https://core.telegram.org/file/400780400031/4/O9Jsl42ber0.98383/bfc2ac7805965d98a0" target="_blank"><img src="https://core.telegram.org/file/400780400031/4/O9Jsl42ber0.98383/bfc2ac7805965d98a0" title="" alt="Telegram User Base Growth" srcset="/file/400780400031/4/O9Jsl42ber0.98383/bfc2ac7805965d98a0 , 2x"></a></div>

Messages you send with the Gateway API can be signed by a [verified](/verify/) channel on Telegram, helping users find updates and support.
...
> For more information, please reference [Section 3.1.](/tos/gateway/) of the [Verification Platform Terms of Service](/tos/gateway/).

##### Q: How do I check if a user can receive my messages on Telegram?

You can use the [checkSendAbility](/gateway/api/#checksendability) method to check if a user can receive your messages on Telegram. If they cannot, your request will be free of charge.

> More details on how pricing works for checks and actual requests are available [in the documentation](/gateway/api/#checksendability).

##### Q: I just received a message in the 'Verification Codes' chat, what is this?

This means that a service is utilizing Telegram Gateway to send a verification code to your phone number. More information is available in the [Telegram FAQ](/faq/#q-does-telegram-send-verification-codes-for-other-apps).
