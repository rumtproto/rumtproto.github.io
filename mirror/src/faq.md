...
section: faq
description: "Telegram is a messaging app with a focus on speed and security, it’s super-fast, simple and free. You can use Telegram on all your devices at the same time — your messages sync…"
crumbs: []
layout: layout.njk
---
...
> Check out our [Advanced FAQ](/techfaq/) for more technical information.
...
> If you are an advanced user, you may find our [FAQ for the Technically Inclined](/techfaq/) useful as well.

#### Q: How secure is Telegram?

Telegram is more secure than mass market messengers like WhatsApp and Line. We are based on the MTProto protocol (see [description](/mtproto/) and [advanced FAQ](/techfaq/)), built upon time-tested algorithms to make security compatible with high-speed delivery and reliability on weak connections. We are continuously working with the community to improve the security of our protocol and clients.
...
We support two layers of secure encryption. [Server-client encryption](/mtproto/) is used in Cloud Chats (private and group chats), Secret Chats use an additional layer of [client-client encryption](/api/end-to-end/). All data, regardless of type, is encrypted in the same way — be it text, media or files.
...
#### Q: What AI model does Telegram use?
...
#### Q: What does Profile Rating mean?
...
The [encryption](/mtproto/) and [API](https://core.telegram.org) used on Telegram's servers are fully documented and open for review by security experts. We welcome any comments at _security@telegram.org_
