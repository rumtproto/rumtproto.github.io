...
crumbs: [{"title":"API","url":"/api/"},{"title":"All Methods","url":"/methods/"},{"title":"messages.toggleSavedDialogPin","url":"/method/messages.toggleSavedDialogPin/"}]
layout: layout.njk
---

# messages.toggleSavedDialogPin

Pin or unpin a [saved message dialog »](/api/saved-messages/).
...
---functions---
<a href="/method/messages.toggleSavedDialogPin/" class="current_page_link">messages.toggleSavedDialogPin</a>#ac81bbde flags:<a href="/type/%23/">#</a> pinned:flags.0?true peer:<a href="/type/InputDialogPeer/">InputDialogPeer</a> = <a href="/type/Bool/">Bool</a>;</code></pre>
