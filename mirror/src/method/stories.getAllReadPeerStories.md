...
crumbs: [{"title":"API","url":"/api/"},{"title":"All Methods","url":"/methods/"},{"title":"stories.getAllReadPeerStories","url":"/method/stories.getAllReadPeerStories/"}]
layout: layout.njk
---

# stories.getAllReadPeerStories

Obtain the latest read story ID for all peers when first logging in, returned as a list of [updateReadStories](/constructor/updateReadStories/) updates, see [here »](/api/stories/#watching-stories) for more info.
...
---functions---
<a href="/method/stories.getAllReadPeerStories/" class="current_page_link">stories.getAllReadPeerStories</a>#9b5ae7f9 = <a href="/type/Updates/">Updates</a>;</code></pre>
