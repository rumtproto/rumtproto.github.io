...
<pre class="page_scheme"><code>Method schema is available as of layer 224. <a href="https://core.telegram.org/method/messages.reportReadMetrics?layer=224">Switch »</a></code></pre>
