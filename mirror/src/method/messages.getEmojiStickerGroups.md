...
crumbs: [{"title":"API","url":"/api/"},{"title":"All Methods","url":"/methods/"},{"title":"messages.getEmojiStickerGroups","url":"/method/messages.getEmojiStickerGroups/"}]
layout: layout.njk
---

# messages.getEmojiStickerGroups

Represents a list of [emoji categories](/api/emoji-categories/), to be used when choosing a sticker.
...
---functions---
<a href="/method/messages.getEmojiStickerGroups/" class="current_page_link">messages.getEmojiStickerGroups</a>#1dd840f5 hash:<a href="/type/int/">int</a> = <a href="/type/messages.EmojiGroups/">messages.EmojiGroups</a>;</code></pre>
