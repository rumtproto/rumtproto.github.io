...
crumbs: [{"title":"API","url":"/api/"},{"title":"All Methods","url":"/methods/"},{"title":"account.getDefaultGroupPhotoEmojis","url":"/method/account.getDefaultGroupPhotoEmojis/"}]
layout: layout.njk
---

# account.getDefaultGroupPhotoEmojis

Get a set of suggested [custom emoji stickers](/api/custom-emoji/) that can be [used as group picture](/api/files/#sticker-profile-pictures)
...
---functions---
<a href="/method/account.getDefaultGroupPhotoEmojis/" class="current_page_link">account.getDefaultGroupPhotoEmojis</a>#915860ae hash:<a href="/type/long/">long</a> = <a href="/type/EmojiList/">EmojiList</a>;</code></pre>
