---
title: "Android SDK"
original: "https://core.telegram.org/passport/sdk-android"
section: other
description: "The Android SDK helps you easily integrate Telegram Passport requests into your Android-based apps. Check out our GitHub repository to see samples using this SDK."
crumbs: [{"title":"Telegram Passport","url":"/passport/"},{"title":"Android SDK","url":"/passport/sdk-android/"}]
layout: layout.njk
---

# Android SDK

The Android SDK helps you easily integrate Telegram Passport requests into your Android-based apps. Check out our [GitHub repository](https://github.com/TelegramMessenger/TGPassportAndroidSDK) to see samples using this SDK.
