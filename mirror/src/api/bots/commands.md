...
The [botInfo](/constructor/botInfo/) constructors contained in the [userFull](/constructor/userFull/), [chatFull](/constructor/chatFull/), [channelFull](/constructor/channelFull/) contain a list of commands, and for groups, the ID and a description of each bot.
...
If the command list of a bot changes, the `bot_info_version` contained in the [user](/constructor/user/) constructor received in updates will change; this indicates that the client should refetch full bot information using [users.getFullUser](/method/users.getFullUser/).
...
The command list can be changed by the owner of the bot through [@botfather](https://t.me/botfather), but bots can also change their own command list by invoking [bots.setBotCommands](/method/bots.setBotCommands/).
