...
Bots can use [bots.setBotMenuButton](/method/bots.setBotMenuButton/) to change the menu button for a certain user, or for all users.
...
-   `button` - one of the following constructors:
    -   [botMenuButton](/constructor/botMenuButton/) - Opens a [bot mini app](/api/bots/webapps/) when clicked.
    -   [botMenuButtonCommands](/constructor/botMenuButtonCommands/) - Opens the bot's command list when clicked.

[botMenuButtonDefault](/constructor/botMenuButton/) shouldn't be used as it has no effect, keeping the previously set menu button (either [botMenuButton](/constructor/botMenuButton/) or [botMenuButtonCommands](/constructor/botMenuButtonCommands/)).

#### Set scope: specific users

To change the menu button for a specific user use the following parameters:

-   `user_id` - [inputUser](/constructor/inputUser/) with the user ID/access hash
-   `button` - one of the following constructors:
    -   [botMenuButton](/constructor/botMenuButton/) - Opens a [bot mini app](/api/bots/webapps/) when clicked.
    -   [botMenuButtonCommands](/constructor/botMenuButtonCommands/) - Opens the bot's command list when clicked.
    -   [botMenuButtonDefault](/constructor/botMenuButton/) - Resets the behavior of the button to the [default scope (all users)](#set-scope-all-users).
...
Bots might need to know the button type currently used in a given chat or in all chats: [bots.getBotMenuButton](/method/bots.getBotMenuButton/) can be used for this.
...
[botMenuButtonDefault](/constructor/botMenuButton/) will never be returned in this case.
...
-   [botMenuButton](/constructor/botMenuButton/) - Opens a [bot mini app](/api/bots/webapps/) when clicked.
-   [botMenuButtonCommands](/constructor/botMenuButtonCommands/) - Opens the bot's command list when clicked.
-   [botMenuButtonDefault](/constructor/botMenuButton/) - The [default scope (all users) button behavior is in use](#get-scope-all-users).
...
Users will receive an [updateBotMenuButton](/constructor/updateBotMenuButton/) update when a bot changes the behavior of the menu button globally or in the private chat with the user.

For new bots, [users.getFullUser](/method/users.getFullUser/) can be used to fetch the [userFull](/constructor/userFull/) related to the bot, containing the [botInfo](/constructor/botInfo/) constructor with various info about the bot, including the menu button behavior.

[botMenuButtonDefault](/constructor/botMenuButton/) will never be returned in an [updateBotMenuButton](/constructor/updateBotMenuButton/) or in a [botInfo](/constructor/botInfo/) (but if it does happen, treat it like a [botMenuButtonCommands](/constructor/botMenuButtonCommands/)).
