...
section: mtproto
description: "Receipt of virtually all messages (with the exception of some purely service ones as well as the plain-text messages used in the protocol for creating an authorization key) must…"
crumbs: [{"title":"Mobile Protocol","url":"/mtproto/"},{"title":"Service messages","url":"/mtproto/service_messages/"},{"title":"Service Messages about Messages","url":"/mtproto/service_messages_about_messages/"}]
layout: layout.njk
---
