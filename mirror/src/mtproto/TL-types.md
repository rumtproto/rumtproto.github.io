...
section: mtproto
description: "See Polymorphism in TL and TL Language."
crumbs: [{"title":"Mobile Protocol","url":"/mtproto/"},{"title":"TL Language","url":"/mtproto/TL/"},{"title":"Type serialization","url":"/mtproto/TL-types/"}]
layout: layout.njk
---

# Type serialization

See [Polymorphism in TL](/mtproto/TL-polymorph/) and [TL Language](/mtproto/TL/).
