...
section: mtproto
description: "MTProto operation requires that elementary and composite data types as well as queries to which such data types are passed as arguments or by which they are returned, be…"
crumbs: [{"title":"Mobile Protocol","url":"/mtproto/"},{"title":"Binary Data Serialization","url":"/mtproto/serialize/"}]
layout: layout.njk
---

# Binary Data Serialization

MTProto operation requires that elementary and composite data types as well as queries to which such data types are passed as arguments or by which they are returned, be transmitted in binary format (i. e. _serialized_) . The [TL language](/mtproto/TL/) is used to describe the data types to be serialized.
...
See also [polymorphism in TL](/mtproto/TL-polymorph/).
