...
section: mtproto
description: "TL (Type Language) serves to describe the used system of types, constructors, and existing functions. In fact, the combinator description format presented in Binary Data…"
crumbs: [{"title":"Mobile Protocol","url":"/mtproto/"},{"title":"TL Language","url":"/mtproto/TL/"}]
layout: layout.njk
---

# TL Language

TL (Type Language) serves to describe the used system of types, constructors, and existing functions. In fact, the combinator description format presented in [Binary Data Serialization](/mtproto/serialize/) is used.

See also:

-   [Polymorphism in TL](/mtproto/TL-polymorph/)

Advanced topics:

-   [Dependent types in TL](/mtproto/TL-dependent/)
    
-   [Formal description of TL](/mtproto/TL-formal/)
    
-   [Formal description of TL combinators](/mtproto/TL-combinators/)
    
-   [Type serialization](/mtproto/TL-types/)
    
-   [TL schema for serialization of TL schemas](/mtproto/TL-tl/)
    
-   [Optional combinator parameters and their values](/mtproto/TL-optargs/)
    
-   [Binary serialization and abstract TL types](/mtproto/TL-abstract-types/)
    
-   [Formal description of templates in TL](/mtproto/TL-patterns/)
