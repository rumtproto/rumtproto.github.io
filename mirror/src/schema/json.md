...
original: "https://core.telegram.org/schema/json"
section: schema
...
crumbs: [{"title":"API","url":"/api/"},{"title":"Schema","url":"/schema/"},{"title":"TL-Schema in JSON","url":"/schema/json/"}]
layout: layout.njk
---
...
```json
{
  "constructors": [
    ...
    {
      "id": "-899896439",
      "predicate": "messageMediaVideoStream",
      "params": [
        {
          "name": "flags",
          "type": "#"
    ...
    {
      "id": "1048963372",
      "predicate": "updateDeleteGroupCallMessages",
      "params": [
        {
          "name": "call",
          "type": "InputGroupCall"
    ...
    {
      "id": "1304334886",
      "predicate": "inputPrivacyKeySavedMusic",
      "params": [],
      "type": "InputPrivacyKey"
    },
    {
      "id": "-8759525",
      "predicate": "privacyKeySavedMusic",
      "params": [],
      "type": "PrivacyKey"
    },
    {
      "id": "-297595771",
      "predicate": "groupCallDonor",
      "params": [
        {
          "name": "flags",
          "type": "#"
    ...
    {
      "id": "-1658995418",
      "predicate": "phone.groupCallStars",
      "params": [
        {
          "name": "total_stars",
          "type": "long"
    ...
    {
      "id": "516618768",
      "predicate": "inputInvoiceStarGiftAuctionBid",
      "params": [
        {
          "name": "flags",
          "type": "#"
    ...
    {
      "id": "-30197422",
      "predicate": "starGiftAuctionStateNotModified",
      "params": [],
    ...
    {
      "id": "787403204",
      "predicate": "starGiftAuctionUserState",
      "params": [
        {
          "name": "flags",
          "type": "#"
    ...
    {
      "id": "1222788802",
      "predicate": "updateStarGiftAuctionState",
      "params": [
        {
          "name": "gift_id",
          "type": "long"
    ...
    {
      "id": "-598150370",
      "predicate": "updateStarGiftAuctionUserState",
      "params": [
        {
          "name": "gift_id",
          "type": "long"
    ...
    {
      "id": "2103169520",
      "predicate": "payments.starGiftAuctionAcquiredGifts",
      "params": [
        {
          "name": "gifts",
    ...
    {
      "id": "-753154979",
      "predicate": "starGiftActiveAuctionState",
      "params": [
        {
          "name": "gift",
          "type": "StarGift"
    ...
    {
      "id": "-617358640",
      "predicate": "payments.starGiftActiveAuctionsNotModified",
      "params": [],
    ...
    {
      "id": "48327832",
      "predicate": "inputStarGiftAuction",
      "params": [
        {
          "name": "gift_id",
          "type": "long"
    ...
    {
      "id": "2058715912",
      "predicate": "inputStarGiftAuctionSlug",
      "params": [
        {
          "name": "slug",
          "type": "string"
  ...
  "methods": [
    ...
    {
      "id": "-162573065",
      "method": "phone.deleteGroupCallMessages",
      "params": [
        {
          "name": "flags",
          "type": "#"
    ...
    {
      "id": "1868784386",
      "method": "phone.getGroupCallStars",
      "params": [
        {
          "name": "call",
          "type": "InputGroupCall"
    ...
    {
      "id": "1805831148",
      "method": "payments.getStarGiftAuctionAcquiredGifts",
      "params": [
        {
          "name": "gift_id",
          "type": "long"
