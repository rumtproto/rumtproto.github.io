...
section: schema
description: "Below you will find the current MTProto TL-schema. More details on TL »"
crumbs: [{"title":"Mobile Protocol","url":"/mtproto/"},{"title":"Current MTProto TL-schema","url":"/schema/mtproto/"}]
layout: layout.njk
---

# Current MTProto TL-schema

Below you will find the current MTProto TL-schema. [More details on TL »](/mtproto/TL/)

See also the [detailed schema in JSON »](/schema/mtproto-json/)
