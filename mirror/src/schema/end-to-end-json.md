...
original: "https://core.telegram.org/schema/end-to-end-json"
section: schema
...
crumbs: [{"title":"API","url":"/api/"},{"title":"Secret chats","url":"/api/end-to-end/"},{"title":"Current end-to-end TL-schema","url":"/schema/end-to-end/"},{"title":"End-to-end TL-Schema in JSON","url":"/schema/end-to-end-json/"}]
layout: layout.njk
---

# End-to-end TL-Schema in JSON
  ...
  "constructors": [
    ...
    },
    {
      ...
      "params": [
        ...
        {
          "name": "media",
          "type": "flags.9?DecryptedMessageMedia"
        },
        {
          "name": "entities",
    ...
    {
      "id": "-1438109059",
      "predicate": "decryptedMessageService",
      "params": [
        {
          "name": "random_id",
          "type": "long"
    ...
    {
      "id": "144661578",
      "predicate": "decryptedMessageMediaEmpty",
      "params": [],
      "type": "DecryptedMessageMedia",
      "layer": 8
    },
    {
      "id": "846826124",
      "predicate": "decryptedMessageMediaPhoto",
      "params": [
        {
          "name": "thumb",
          "type": "bytes"
    ...
    {
      "id": "893913689",
      "predicate": "decryptedMessageMediaGeoPoint",
      "params": [
        {
          "name": "lat",
          "type": "double"
    ...
    {
      "id": "1485441687",
      "predicate": "decryptedMessageMediaContact",
      "params": [
        {
          "name": "phone_number",
          "type": "string"
    ...
    {
      "id": "-1586283796",
      "predicate": "decryptedMessageActionSetMessageTTL",
      "params": [
        {
          "name": "ttl_seconds",
          "type": "int"
    ...
    {
      "id": "-1332395189",
      "predicate": "decryptedMessageMediaDocument",
      "params": [
        {
          "name": "thumb",
          "type": "bytes"
    ...
    {
      "id": "1619031439",
      "predicate": "decryptedMessageMediaAudio",
      "params": [
        {
          "name": "duration",
          "type": "int"
    ...
    {
      "id": "206520510",
      "predicate": "decryptedMessageActionReadMessages",
      "params": [
        {
          "name": "random_ids",
          "type": "Vector<long>"
    ...
    {
      "id": "1700872964",
      "predicate": "decryptedMessageActionDeleteMessages",
      "params": [
        {
          "name": "random_ids",
          "type": "Vector<long>"
    ...
    {
      "id": "-1967000459",
      "predicate": "decryptedMessageActionScreenshotMessages",
      "params": [
        {
          "name": "random_ids",
          "type": "Vector<long>"
    ...
    {
      "id": "1729750108",
      "predicate": "decryptedMessageActionFlushHistory",
      "params": [],
      "type": "DecryptedMessageAction",
      "layer": 8
    },
    {
      "id": "467867529",
      "predicate": "decryptedMessageLayer",
      "params": [
        {
          "name": "random_bytes",
          "type": "bytes"
    ...
    {
      "id": "1360072880",
      "predicate": "decryptedMessageActionResend",
      "params": [
        {
          "name": "start_seq_no",
          "type": "int"
    ...
    {
      "id": "-217806717",
      "predicate": "decryptedMessageActionNotifyLayer",
      "params": [
        {
          "name": "layer",
          "type": "int"
    ...
    {
      "id": "-860719551",
      "predicate": "decryptedMessageActionTyping",
      "params": [
        {
          "name": "action",
          "type": "SendMessageAction"
    ...
    {
      "id": "1877046107",
      "predicate": "decryptedMessageActionAcceptKey",
      "params": [
        {
          "name": "exchange_id",
          "type": "long"
    ...
    {
      "id": "-586814357",
      "predicate": "decryptedMessageActionAbortKey",
      "params": [
        {
          "name": "exchange_id",
          "type": "long"
    ...
    {
      "id": "-332526693",
      "predicate": "decryptedMessageActionCommitKey",
      "params": [
        {
          "name": "exchange_id",
          "type": "long"
    ...
    {
      "id": "-1473258141",
      "predicate": "decryptedMessageActionNoop",
      "params": [],
      "type": "DecryptedMessageAction",
      "layer": 20
    },
    ...
    {
      "id": "-90853155",
      "predicate": "decryptedMessageMediaExternalDocument",
      "params": [
        {
          "name": "id",
          "type": "long"
    ...
    {
      "id": "-1978796689",
      "predicate": "decryptedMessageMediaVenue",
      "params": [
        {
          "name": "lat",
          "type": "double"
    ...
    {
      "id": "-452652584",
      "predicate": "decryptedMessageMediaWebPage",
      "params": [
        {
          "name": "url",
          "type": "string"
