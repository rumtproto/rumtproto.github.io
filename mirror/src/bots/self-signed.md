...
original: "https://core.telegram.org/bots/self-signed"
section: bots
description: "Upload your certificate using the _certificate_ parameter in the setWebhook method. The certificate supplied should be PEM encoded (ASCII BASE64), the pem file should only contain…"
crumbs: [{"title":"Telegram Bots","url":"/bots/"},{"title":"FAQ","url":"/bots/faq/"},{"title":"Using self-signed certificates","url":"/bots/self-signed/"}]
layout: layout.njk
---

# Using self-signed certificates

Upload your certificate using the _certificate_ parameter in the [setWebhook](/bots/api/#setwebhook) method. The certificate supplied should be **PEM encoded** (ASCII BASE64), the pem file should only contain the **public key** (including BEGIN and END portions). When converting from a bundle format, please split the file to only include the public key.
